//#include "ProjectAkhir.h"
//
//using namespace Engine;
//
//ProjectAkhir::ProjectAkhir(Setting* setting) :Game(setting)
//{
//
//}
//
//
//ProjectAkhir::~ProjectAkhir()
//{
//	delete crateTexture;
//	delete crateSprite;
//	delete crateSprite2;
...
//
//	// a monster spritesheet has 5 cols and 3 rows (total frames = 5x3 = 15 frames)
//	monsterTexture = new Texture("bird.png");
